...
DAVIS2017_DEFAULT_PATH = "/home/" + username() + "/Documents/Segment/OnAVOSold/custom_dataset/"
...
class DAVIS2017Dataset(ImageDataset):
  def __init__(self, config, subset, coord, fraction=1.0):
    ...
    self.img_placeholder = tf.placeholder(tf.float32, shape=(1,None, None, 3), name="img_placeholder")
    self.label_placeholder = tf.placeholder(tf.float32, shape=(1,None, None, 1), name="label_placeholder")
  ...
  def read_inputfile_lists(self):
    ...
    # imgs = self.img_placeholder
    # ans = self.label_placeholder
    return imgs, ans

  # def create_input_tensors_dict(self, batch_size = 1):
  #   # img = normalize(self.img_placeholder)
  #   img = self.img_placeholder
  #
  #   tensors = {"inputs": img, "labels": self.label_placeholder, "tags": "image", "raw_labels": self.label_placeholder}
  #
  #   return tensors
